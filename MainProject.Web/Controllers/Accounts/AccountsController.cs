namespace MainProject.Web.Controllers.Accounts
{
    ...
    using MainProject.Core.Handlers.Accounts.ChangePasswordRequestHandler;
    using MainProject.Core.Handlers.Accounts.EstablishNewPasswordRequestHandler;
    using MainProject.Core.Handlers.Accounts.SendRecoveryEmailRequestHandler;
    using MainProject.Core.Handlers.Accounts.UserLoginRequestHandler;
    using MainProject.Core.Handlers.Accounts.UserLogOutRequestHandler;
    using MainProject.Core.Handlers.Accounts.VerifyLoginDeviceRequestHandler;
